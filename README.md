...
- `smart3seq_summary.sh` bash script that summarizes dedeuplicated *.bam* files into a counts table using [featureCounts](https://subread.sourceforge.net/featureCounts.html) and generates a quality control report using [MultiQC](https://multiqc.info/docs/). 
