...
def main():
    ...
    # if the user wants custom TSO sequences, extract the sequences from the csv
    ...
    # if the user wants to use the default TSO sequences, use the hardcoded dictionary
    else:
